...
use crate::{
    ...
    model::{AssetAction, AssetId, AssetValue, BlockHeight, O2mIndexValue, TxHash, TxIndex},
};
...
impl TxReadService for EuTxReadService {
    ...
    fn get_txs_by_height(&self, block_height: &BlockHeight) -> Result<Vec<EuTx>, rocksdb::Error> {
