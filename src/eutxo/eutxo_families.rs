...
pub struct EutxoFamilies<'db> {
    ...
    pub o2m_utxo_birth_pk_relations_cf: HashMap<DbIndexCfIndexNumber, Arc<BoundColumnFamily<'db>>>,
    pub o2m_utxo_birth_pk_by_index_cf: HashMap<DbIndexCfIndexNumber, Arc<BoundColumnFamily<'db>>>,
    pub o2m_index_by_utxo_birth_pk_cf: HashMap<DbIndexCfIndexNumber, Arc<BoundColumnFamily<'db>>>,
    pub o2o_utxo_birth_pk_by_index_cf: HashMap<DbIndexCfIndexNumber, Arc<BoundColumnFamily<'db>>>,
