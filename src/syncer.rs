...
impl<B: Send + 'static, BH: 'static> ChainSyncer<B, BH> {
    ...
    pub async fn sync(&self, end_height: Height, batch_size: usize) -> () {
        ...
        tokio_stream::iter(heights)
            ...
            .min_batch(batch_size, |(_, _, tx_count)| *tx_count)
            .map(|blocks| {
            ...
            .fold(0 as u64, |total_tx_count, tx_count| async move {
                let total_time = start_time.elapsed().as_secs();
                let txs_per_sec = format!("{:.1}", total_tx_count as f64 / total_time as f64);
                if total_tx_count % 10000 == 0 {
